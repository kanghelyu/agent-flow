...
The PowerShell command must be run from the AgentFlow directory.
...
See [INSTALL.md](INSTALL.md), [RUNTIME.md](RUNTIME.md), and [README.zh-CN.md](README.zh-CN.md) for platform details.

## License

AgentFlow is MIT licensed. The desktop pet shell includes the MIT-licensed [pixelpets](https://github.com/JOhnsonKC201/pixelpets) project; see [ATTRIBUTION.md](ATTRIBUTION.md).
